...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Patient/f:animal</sch:title>
    <sch:rule context="f:Patient/f:animal">
      <sch:assert test="count(f:id) &lt;= 0">id: maximum cardinality of 'id' is 0</sch:assert>
      <sch:assert test="count(f:extension) &lt;= 0">extension: maximum cardinality of 'extension' is 0</sch:assert>
      <sch:assert test="count(f:modifierExtension) &lt;= 0">modifierExtension: maximum cardinality of 'modifierExtension' is 0</sch:assert>
      <sch:assert test="count(f:species) &lt;= 0">species: maximum cardinality of 'species' is 0</sch:assert>
      <sch:assert test="count(f:breed) &lt;= 0">breed: maximum cardinality of 'breed' is 0</sch:assert>
      <sch:assert test="count(f:genderStatus) &lt;= 0">genderStatus: maximum cardinality of 'genderStatus' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:link">
      ...
      <sch:assert test="count(f:extension) &lt;= 0">extension: maximum cardinality of 'extension' is 0</sch:assert>
      <sch:assert test="count(f:modifierExtension) &lt;= 0">modifierExtension: maximum cardinality of 'modifierExtension' is 0</sch:assert>
      <sch:assert test="count(f:other) &lt;= 0">other: maximum cardinality of 'other' is 0</sch:assert>
